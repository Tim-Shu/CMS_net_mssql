...
namespace QJcms.Web.UI.Page
{
    public partial class search : Web.UI.BasePage
    {
        ...
        protected override void ShowPage()
        {
            ...
            keyword = QJRequest.GetQueryStringValue("keyword");
            channel_name = QJRequest.GetQueryStringValue("channel_name");
        }
        ...
        protected DataTable get_search_list(int _pagesize, out int _totalcount)
        {
            ...
            //组合查询条件 or a.zhaiyao like '%" + keyword + "%'
            string strWhere = "(a.title like '%" + keyword + "%') " + strwhere;
