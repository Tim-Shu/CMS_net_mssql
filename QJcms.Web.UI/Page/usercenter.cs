...
namespace QJcms.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            {
                //清险Session
                HttpContext.Current.Session[QJConst.SESSION_USER_INFO] = null;
                //清除Cookies
                Utils.WriteCookie(QJConst.COOKIE_USER_NAME_REMEMBER, "QJcms", -43200);
                Utils.WriteCookie(QJConst.COOKIE_USER_PWD_REMEMBER, "QJcms", -43200);
                Utils.WriteCookie("UserName", "QJcms", -1);
                Utils.WriteCookie("Password", "QJcms", -1);
                //自动登录,跳转URL
