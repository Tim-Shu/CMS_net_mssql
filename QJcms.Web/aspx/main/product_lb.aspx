...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable list = get_article_list("product", category_id, page, "status=0", out totalcount, out pagelist, "product_lb", category_id, "__id__");

	foreach(DataRow acpabdr in list.Rows)
	{

	templateBuilder.Append("\r\n                    <div class=\"cplist\">\r\n                        <a href='");
	templateBuilder.Append(linkurl("products",Utils.ObjectToStr(acpabdr["id"])));

	templateBuilder.Append("'>\r\n                            <div class=\"cplist1\">\r\n                                <div class=\"cpimg\">\r\n                                    <div class=\"cpimg1\" style=\"background:url(" + Utils.ObjectToStr(acpabdr["img_url"]) + ") no-repeat 50% 50%; background-size:cover;\">\r\n                                        <div class=\"cpimg2\"></div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"cptit\">" + Utils.ObjectToStr(acpabdr["title"]) + "</div>\r\n                            </div>\r\n                        </a>\r\n                    </div>\r\n                    ");
	}	//end for if
