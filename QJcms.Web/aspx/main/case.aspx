...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable list = get_article_list("case", category_id, page, "status=0", out totalcount, out pagelist, "case_lb", category_id, "__id__");

	foreach(DataRow acpabdr in list.Rows)
	{

	templateBuilder.Append("\r\n                    <div class=\"cplist\">\r\n                        <a href='");
	templateBuilder.Append(linkurl("cases",Utils.ObjectToStr(acpabdr["id"])));
