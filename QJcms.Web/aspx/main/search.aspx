<%@ Page Language="C#" AutoEventWireup="true" Inherits="QJcms.Web.UI.Page.search" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n            <div class=\"ctn-right\">\r\n                <div class=\"crt\"><div class=\"crtl\">搜索结果</div><div class=\"crtr\">您现在的位置：首页>搜索结果</div></div>\r\n                <div class=\"crb\">\r\n                    ");
	DataTable list = get_search_list(9, out totalcount);

	string pagelist = get_page_link(9, page, totalcount, "search.aspx?keyword=" + Server.UrlEncode(keyword) + "&page=__id__");
	...
	templateBuilder.Append("\r\n                    <div class=\"cplist\">\r\n                        <a href=\"" + Utils.ObjectToStr(dr["link_url"]) + "\">\r\n                            <div class=\"cplist1\">\r\n                                <div class=\"cpimg\">\r\n                                    <div class=\"cpimg1\" style=\"background:url(" + Utils.ObjectToStr(dr["img_url"]) + ") no-repeat 50% 50%; background-size:cover;\">\r\n                                        <div class=\"cpimg2\"></div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"cptit\">" + Utils.ObjectToStr(dr["title"]) + "</div>\r\n                            </div>\r\n                        </a>\r\n                    </div>\r\n                    ");
	}	//end for if

	if (totalcount==0)
	{

	templateBuilder.Append("\r\n                    <div style=\"margin-top:15px;text-align:center;color:red; tab-size:8px;\">\r\n                        搜索结果不存在，请重新输入关键字！\r\n                    </div>\r\n                    ");
	}
	else
	{
	...
	templateBuilder.Append("  ]</span>共<span>");
	templateBuilder.Append(Utils.ObjectToStr(totalcount));
	templateBuilder.Append("</span>条记录\r\n                    </div>\r\n                    ");
	}	//end for if
