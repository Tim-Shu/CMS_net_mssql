    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".upload-img").each(function () {
              $(this).InitSWFUpload({ channelid: "<%=channel_id %>", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", view: $(this).parent().find("img.img-view") });
            });
          
          $(".img-view").each(function () {
            var srcPath = $(this).parent().parent().find(".upload-path").val();
            if (srcPath != "") {
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="article_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="article_list.aspx?channel_id=<%=this.channel_id %>"><span>内容管理</span></a> <i class="arrow">
        </i><span>编辑信息</span>
    </div>
    <div class="line10">
    </div>
    ...
    <div class="tab-content">
        ...
        <dl runat="server" id="dlCall">
            ...
            <dd>
                ...
                <span class="Validform_checktip">*别名访问，不可重复,填写后不可修改。只允许字母、数字、下划线</span>
            </dd>
        </dl>
        <dl runat="server" id="dlCover">
            <dt>封面图片</dt>
            <dd>
              ...
              <div class="view-img-box">
                <img src="../skin/default/loadimg.gif" class="img-view" />
              </div>
            </dd>
        </dl>
                        ...
                        <asp:Repeater ID="rptAttachList" runat="server">
                            <ItemTemplate>
                                <li>
                                    ...
                                    <i class="icon"></i><a href="javascript:;" onclick="delAttachNode(this);" class="del" title="删除附件"></a><a href="javascript:;" onclick="showAttachDialog(this);" class="edit" title="更新附件"></a>
                                    <div class="title">
                                        <%#Eval("file_name")%></div>
                                    <div class="info">
                                    ...
                                    <div class="btns" style="display: none;">
                                        下载积分：<input type="text" name="txt_attach_point" onkeydown="return checkNumber(event);" value="<%#Eval("point")%>" /></div>
                                </li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ul>
    ...
    <div id="field_tab_content" runat="server" visible="false" class="tab-content">
    </div>
    <div class="tab-content">
    ...
    <div class="tab-content" runat="server" id="div_Seo">
        <dl>
            <dt>SEO标题</dt>
            <dd>
