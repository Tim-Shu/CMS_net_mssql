<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_edit.aspx.cs" Inherits="QJcms.Web.admin.article.comment_edit" ValidateRequest="false" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);">回复评论信息</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  <dl>
    <dt>文章标题</dt>
    <dd><%=new QJcms.BLL.article().GetTitle(model.article_id)%></dd>
  </dl>
  <dl>
    <dt>评论用户</dt>
