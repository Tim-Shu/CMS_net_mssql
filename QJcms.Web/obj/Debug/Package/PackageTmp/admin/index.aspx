...
<script type="text/javascript">
                ...
                $(this).children("li").each(function () {
                    ...
                    if (liObj.children("ul").length > 0) { //如果有下级菜单
                        ...
                        liObj.children("a").click(function () {
                            ...
                            $(this).addClass("selected");
                            //保存到cookie
                            addCookie("qj_manage_navigation_cookie", $(this).attr("navid"), 240);
                        });
                    }
                });
                //显示第一个UL
    ...
    function linkMenuTree(islink, navid) {
        ...
        if (argument == 2) {
            ...
            cookieObj = $("#sidebar-nav").find('a[navid="' + getCookie("qj_manage_navigation_cookie") + '"]');
        }
        if (cookieObj.length > 0) {
            ...
            //检查是否需要保存到cookie
            if (argument == 2) {
                addCookie("qj_manage_navigation_cookie", navid, 240);
            }
            //检查是否需要跳转链接
            if (islink == true) {
            ...
            $("#sidebar-nav .list-box .list-group ul li a").removeClass("selected");
            //保存到cookie
            addCookie("qj_manage_navigation_cookie", "", 240);
        }
    }
    //初始化快捷导航菜单
