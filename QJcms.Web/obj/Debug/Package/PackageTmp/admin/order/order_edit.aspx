<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_edit.aspx.cs" Inherits="QJcms.Web.admin.order.order_edit" ValidateRequest="false" %>
...
<body class="mainbody">
	...
	<!--导航栏-->
	<div class="location">
		<a href="express_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="order_list.aspx"><span>订单管理</span></a> <i class="arrow"></i><span>订单详细</span>
	</div>
	<div class="line10">
	</div>
	<!--/导航栏-->
	...
	<div class="content-tab-wrap">
		<div id="floatHead" class="content-tab">
			<div class="content-tab-ul-wrap">
				<ul>
					<li><a href="javascript:;" onclick="tabs(this);">订单详细信息</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="tab-content">
	   ...
	   { %>
					<div class="order-flow-left">
						<a class="order-flow-input">生成</a> <span>
	   ...
	   { %>
					<div class="order-flow-wait">
						<a class="order-flow-input">付款</a> <span>
							<p class="name">
								等待付款</p>
						</span>
					</div>
	   ...
	   { %>
					<div class="order-flow-wait">
						<a class="order-flow-input">确认</a> <span>
							<p class="name">
								等待确认</p>
						</span>
					</div>
	   ...
	   { %>
					<div class="order-flow-wait">
						<a class="order-flow-input">发货</a> <span>
							<p class="name">
								等待发货</p>
						</span>
					</div>
	   ...
	   {%>
					<div style="text-align: center; line-height: 30px; font-size: 20px; color: Red;">
						该订单已取消</div>
					<%}
	   ...
	   { %>
		...
		<dl>
			<dt>订单号</dt>
			<dd>
				<span id="spanOrderNo"><%=model.order_no%></span></dd>
		</dl>
			...
			<dd>
				<table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
					...
					<tr>
						...
						<td>
							<span id="spanArea"><%=model.area %></span>
							<span id="spanAddress"><%=model.address %></span>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<span id="spanPostCode"><%=model.post_code %></span>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<span id="spanMobile"><%=model.mobile %></span>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<span id="spanTelphone"><%=model.telphone %></span>
						</td>
					</tr>
				</table>
			</dd>
			...
			<dd>
				<table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
					...
					<tr>
						...
						<td>
							<asp:Label ID="lbUserGroup" runat="server" Text="-" />
						</td>
					</tr>
					<tr>
						<th>
					...
					<%if (siteConfig.memberamountstatus == 1)
	   { %>
					<tr>
						<th>
							账户余额
			...
			<dd>
				<table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
					<tr>
						...
						<td>
							<%=new QJcms.BLL.payment().GetTitle(model.payment_id) %>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<%=new QJcms.BLL.express().GetTitle(model.express_id) %>
						</td>
					</tr>
					<tr>
						<th>
			...
			<dd>
				<table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
					<tr>
						...
						<td>
							<div class="position">
								<span id="spanRealAmountValue"><%=model.real_amount.ToString("0.00")%></span> 元
					...
					<tr>
						...
						<td>
							<div class="position">
								<span id="spanExpressFeeValue"><%=model.express_fee.ToString("0.00") %></span> 元
					...
					<tr>
						...
						<td>
							<div class="position">
								<span id="spanPaymentFeeValue"><%=model.payment_fee.ToString("0.00")%></span> 元
					...
					<tr>
						...
						<td>
							<%=model.order_amount.ToString("0.00")%>
							元
						</td>
					</tr>
				</table>
