<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_edit.aspx.cs" Inherits="QJcms.Web.admin.manager.role_edit" ValidateRequest="false" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);">编辑角色信息</a></li>
      </ul>
    </div>
  </div>
</div>
