<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_field_list.aspx.cs" Inherits="QJcms.Web.admin.channel.attribute_field_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="attribute_field_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
      ...
      <div class="menu-list">
        <div class="rule-single-select">
            <asp:DropDownList ID="ddlControlType" runat="server" AutoPostBack="True" onselectedindexchanged="ddlControlType_SelectedIndexChanged">
                ...
                <asp:ListItem Value="data-property">属性规格</asp:ListItem>
            </asp:DropDownList>
        </div>
      </div>
    </div>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="attribute_field_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
