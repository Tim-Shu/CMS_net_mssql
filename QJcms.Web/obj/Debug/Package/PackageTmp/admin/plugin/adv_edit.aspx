<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_edit.aspx.cs" Inherits="QJcms.Web.admin.plugin.adv_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="adv_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>实用工具</span> <i class="arrow"></i><span>广告管理</span> <i class="arrow"></i><span>编辑广告位</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div class="content-tab-wrap">
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a href="javascript:;" onclick="tabs(this);">编辑广告位</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="tab-content">
        ...
        <dl runat="server" id="dlPrice" visible="false">
            <dt>价格</dt>
            <dd>
