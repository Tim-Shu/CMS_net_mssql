<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="serv_list.aspx.cs" Inherits="QJcms.Web.admin.plugin.serv_list" %>
...
<body class="mainbody">
    ...
    <div class="toolbar-wrap">
        <div id="floatHead" class="toolbar">
            <div class="l-list">
                <ul class="icon-list">
                    <li><a class="add" href="serv_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
                    ...
                    <li><a class="list" href="serv_view.aspx"><i></i><span>调用代码</span></a></li>
                </ul>
                <div class="menu-list">
    ...
    <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="serv_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                        <%#Eval("title")%></a>
                </td>
                <td>
                    <%#new QJcms.BLL.online_service_group().GetTitle(Convert.ToInt32(Eval("group_id")))%>
                </td>
                <td>
                    <a target="_blank" href="<%#Eval("link_url")%>">
                ...
                <td align="center">
                    <a href="serv_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
