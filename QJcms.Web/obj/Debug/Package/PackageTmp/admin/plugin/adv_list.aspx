<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_list.aspx.cs" Inherits="QJcms.Web.admin.plugin.adv_list" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="javascript:history.back(-1);" class="back"><i></i><span>返回上一页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>实用工具</span> <i class="arrow"></i><span>广告管理</span> <i class="arrow"></i><span>广告位</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
    <div class="toolbar-wrap">
        <div id="floatHead" class="toolbar">
            <div class="l-list">
                <ul class="icon-list">
                    <li runat="server" id="tool_add"><a class="add" href="adv_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
    ...
    <asp:Repeater ID="rptList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="adv_edit.aspx?action=<%=QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                        <%#Eval("title")%></a>
                </td>
                <td>
                ...
                <td align="center">
                    <a href="bar_list.aspx?aid=<%#Eval("id")%>">内容</a>&nbsp; <a href="adv_view.aspx?id=<%#Eval("id")%>">调用</a>&nbsp; <a href="adv_edit.aspx?action=<%=QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">编辑</a>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
