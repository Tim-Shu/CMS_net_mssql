<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback_list.aspx.cs" Inherits="QJcms.Web.admin.plugin.feedback_list" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="javascript:history.back(-1);" class="back"><i></i><span>返回上一页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>实用工具</span> <i class="arrow"></i><span>在线留言</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
    ...
    <asp:Repeater ID="rptList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="feedback_reply.aspx?id=<%#Eval("id")%>">
                ...
                <td align="center">
                    <a href="feedback_reply.aspx?id=<%#Eval("id")%>">回复</a>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
