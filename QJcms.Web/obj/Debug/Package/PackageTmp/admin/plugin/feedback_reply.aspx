<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback_reply.aspx.cs" Inherits="QJcms.Web.admin.plugin.feedback_reply" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="index.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../../../<%=siteConfig.webmanagepath %>/center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="index.aspx"><span>物流配送</span></a> <i class="arrow"></i><span>插件管理</span> <i class="arrow">
        </i><span>在线留言</span> <i class="arrow"></i><span>回复留言</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
