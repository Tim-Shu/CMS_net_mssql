<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="serv_edit.aspx.cs" Inherits="QJcms.Web.admin.plugin.serv_edit" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="serv_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>实用工具</span> <i class="arrow"></i><span>客服管理</span> <i class="arrow"></i><span>编辑客服</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div class="tab-content">
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    <asp:DropDownList ID="ddlGroupId" runat="server" datatype="*" sucmsg=" ">
                    </asp:DropDownList>
                </div>
            </dd>
        </dl>
        ...
        <dl>
            <dt>链接地址</dt>
            <dd>
                <asp:TextBox ID="txtLinkUrl" runat="server" MaxLength="255" CssClass="input normal" /></dd>
        </dl>
        <dl>
            <dt>图片地址</dt>
            <dd>
