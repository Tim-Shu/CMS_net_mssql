<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="serv_group_edit.aspx.cs" Inherits="QJcms.Web.admin.plugin.serv_group_edit" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="serv_group_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>实用工具</span> <i class="arrow"></i><span>客服管理</span> <i class="arrow"></i><span>编辑分组</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
