<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oauth_app_edit.aspx.cs" Inherits="QJcms.Web.admin.users.oauth_app_edit" ValidateRequest="false" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);">编辑OAuth应用</a></li>
      </ul>
    </div>
  </div>
</div>
