...
namespace QJcms.Web.admin.users
{
    public partial class point_log : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("user_point_log", QJEnums.ActionEnum.View.ToString()); //检查权限
        ...
        {
            ChkAdminLevel("user_point_log", QJEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.user_point_log bll = new BLL.user_point_log();
            ...
            AddAdminLog(QJEnums.ActionEnum.Delete.ToString(), "删除积分日专成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
