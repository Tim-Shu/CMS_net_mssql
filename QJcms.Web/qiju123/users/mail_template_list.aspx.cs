...
namespace QJcms.Web.admin.users
{
    public partial class mail_template_list : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("user_mail_template", QJEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.mail_template bll = new BLL.mail_template();
            ...
            AddAdminLog(QJEnums.ActionEnum.Delete.ToString(), "删除邮件模板成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
