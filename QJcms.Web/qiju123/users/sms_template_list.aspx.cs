...
namespace QJcms.Web.admin.users
{
    public partial class sms_template_list : Web.UI.ManagePage
    {
        ...
        {
            ChkAdminLevel("user_sms_template", QJEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.sms_template bll = new BLL.sms_template();
            ...
            AddAdminLog(QJEnums.ActionEnum.Delete.ToString(), "删除短信模板成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
