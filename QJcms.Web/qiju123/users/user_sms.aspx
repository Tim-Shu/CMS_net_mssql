<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_sms.aspx.cs" Inherits="QJcms.Web.admin.users.user_sms" ValidateRequest="false" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);">批量短信通知</a></li>
      </ul>
    </div>
  </div>
</div>
