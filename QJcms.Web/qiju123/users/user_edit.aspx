<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_edit.aspx.cs" Inherits="QJcms.Web.admin.users.user_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="user_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>会员管理</span> <i class="arrow"></i><span>编辑用户</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div class="tab-content">
        ...
        <dl>
            <dt>用户名</dt>
            <dd>
                <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " ajaxurl="../../tools/admin_ajax.ashx?action=validate_username"></asp:TextBox>
    ...
    <div class="tab-content">
        <dl runat="server" id="dlAmount">
            <dt>账户金额</dt>
            <dd>
                <asp:TextBox ID="txtAmount" runat="server" CssClass="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox>
                元 <span class="Validform_checktip">*账户上的余额</span>
            </dd>
        </dl>
        <dl runat="server" id="dlPoint">
            <dt>账户积分</dt>
            <dd>
