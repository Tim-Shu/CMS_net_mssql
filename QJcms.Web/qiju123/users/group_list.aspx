<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_list.aspx.cs" Inherits="QJcms.Web.admin.users.group_list" %>
...
<body class="mainbody">
    ...
    <div class="toolbar-wrap">
        <div id="floatHead" class="toolbar">
            <div class="l-list">
                <ul class="icon-list">
                    <li><a class="add" href="group_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i>
                        <span>新增</span></a></li>
    ...
    <asp:Repeater ID="rptList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="group_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                        <%#Eval("title")%></a>
                </td>
                <td align="center">
                    <%#Eval("grade")%>
                ...
                <td align="center">
                    <a href="group_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
