<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_attach.aspx.cs" Inherits="QJcms.Web.admin.dialog.dialog_attach" %>
...
<script type="text/javascript">
    ...
    //页面加载完成执行
    $(function () {
        $(".upload-attach").InitSWFUpload({ filesize: "20480", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;*.rar;*.zip;*.doc;*.xls;*.mp4;*.pdf" });
    ...
    function appendAttachHtml(fileName, filePath, fileExt, fileSize, fileSizeStr) {
        if ($(api.data).length > 0) {
            ...
            + '<div class="btns" style="display:none;">下载积分：<input type="text" name="txt_attach_point" onkeydown="return checkNumber(event);" value="0" /></div>'
            + '</li>';
