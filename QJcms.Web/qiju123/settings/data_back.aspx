<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="data_back.aspx.cs" Inherits="QJcms.Web.admin.settings.data_back" %>
  ...
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        ...
        <li><asp:LinkButton ID="lbtnCompr" runat="server" CssClass="compr" onclick="lbtnCompr_Click"><i></i><span>压缩</span></asp:LinkButton></li>
