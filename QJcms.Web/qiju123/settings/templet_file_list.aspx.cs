...
namespace QJcms.Web.admin.settings
{
    public partial class templet_file_list : Web.UI.ManagePage
    {
        ...
        {
            skinName = QJRequest.GetQueryString("skin");
        ...
        {
            ChkAdminLevel("app_templet_list", QJEnums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(QJEnums.ActionEnum.Delete.ToString(), "删除模板文件，模板:" + this.skinName);//记录日志
