...
namespace QJcms.Web.admin.channel
{
    public partial class attribute_field_list : Web.UI.ManagePage
    {
        ...
        {
            this.control_type = QJRequest.GetQueryString("control_type");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(QJEnums.ActionEnum.Edit.ToString(), "保存扩展字段排序"); //记录日志
        ...
        {
            ChkAdminLevel("site_channel_field", QJEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            AddAdminLog(QJEnums.ActionEnum.Delete.ToString(), "删除扩展字段成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
