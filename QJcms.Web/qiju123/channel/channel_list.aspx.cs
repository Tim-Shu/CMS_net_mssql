...
namespace QJcms.Web.admin.channel
{
    public partial class channel_list : Web.UI.ManagePage
    {
        ...
        {
            this.category_id = QJRequest.GetQueryInt("category_id");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(QJEnums.ActionEnum.Edit.ToString(), "保存频道排序"); //记录日志
        ...
        {
            ChkAdminLevel("site_channel_list", QJEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.channel bll = new BLL.channel();
            for (int i = 0; i < rptList.Items.Count; i++)
            ...
            AddAdminLog(QJEnums.ActionEnum.Delete.ToString(), "删除频道成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
