...
{
    public partial class serv_group_list : QJcms.Web.UI.ManagePage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(QJEnums.ActionEnum.Delete.ToString(), "删除客服分组成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", "serv_group_list.aspx", "Success");
        }
    }
}