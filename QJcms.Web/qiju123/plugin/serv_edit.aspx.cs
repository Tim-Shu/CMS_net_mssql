...
{
    public partial class serv_edit : QJcms.Web.UI.ManagePage
    {
        ...
        private bool DoAdd()
        {
            ...
            if (bll.Add(model) > 0)
            {
                AddAdminLog(QJEnums.ActionEnum.Add.ToString(), "添加在线客服：" + model.title); //记录日志
                result = true;
            }
            return result;
        }
        ...
        private bool DoEdit(int _id)
        {
            ...
            if (bll.Update(model))
            {
                AddAdminLog(QJEnums.ActionEnum.Edit.ToString(), "修改在线客服：" + model.title); //记录日志
                result = true;
            }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == QJEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("编辑成功啦！", "serv_list.aspx", "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加成功啦！", "serv_list.aspx", "Success");
            }
        }
    }
}