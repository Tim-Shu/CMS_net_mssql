<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="link_list.aspx.cs" Inherits="QJcms.Web.admin.plugin.link_list" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="javascript:history.back(-1);" class="back"><i></i><span>返回上一页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>实用工具</span> <i class="arrow"></i><span>友情链接</span>
    </div>
    <!--/导航栏-->
    <!--工具栏-->
    <div class="toolbar-wrap">
        <div id="floatHead" class="toolbar">
            <div class="l-list">
                <ul class="icon-list">
                    <li><a class="add" href="link_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
    ...
    <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="link_edit.aspx?action=<%=QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">
                        <%#Eval("title")%><%# Convert.ToInt32(Eval("is_lock")) == 1 ? "(未审核)" : ""%></a>
                </td>
                <td>
                    <%# Convert.ToInt32(Eval("is_image")) == 0 ? "文字链接" : "<img src=\"" + Eval("img_url") + "\" width=\"50\" height=\"20\" />"%>
                </td>
                <td>
                ...
                <td align="center">
                    <a href="link_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
