<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search_keyword_edit.aspx.cs" Inherits="QJcms.Web.admin.plugin.search_keyword_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
     <!--导航栏-->
    <div class="location">
        <a href="link_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a> <i class="arrow"></i><span>系统管理</span> <i class="arrow"></i><span>搜索关键词</span> <i class="arrow"></i><span>编辑关键词</span>
    </div>
    <div class="line10">
    </div>
    <!--/导航栏-->
    ...
    <div class="content-tab-wrap">
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑搜索关键词</a></li>
                </ul>
            </div>
        </div>
    </div>
