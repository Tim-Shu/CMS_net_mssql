<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_log.aspx.cs" Inherits="QJcms.Web.admin.manager.manager_log" %>
        ...
        <div id="floatHead" class="toolbar">
            <div class="l-list">
                <ul class="icon-list">
                  ...
                  <li>
                        <asp:LinkButton ID="btnClear" runat="server" CssClass="del" OnClientClick="return ExeNoCheckPostBack('btnClear','删除所有的管理日志，你确定吗?');"
                            OnClick="btnClear_Click" Visible="false"><i></i><span>清空日志</span></asp:LinkButton>
                    </li>                   
                </ul>
            </div>
            <div class="r-list">
