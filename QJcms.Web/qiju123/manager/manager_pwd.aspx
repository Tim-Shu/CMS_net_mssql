<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_pwd.aspx.cs" Inherits="QJcms.Web.admin.manager.manager_pwd" ValidateRequest="false" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);">修改密码</a></li>
      </ul>
    </div>
  </div>
</div>
