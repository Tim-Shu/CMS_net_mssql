...
namespace QJcms.Web.api.payment.alipay
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //=============================获得订单信息================================
            string order_no = QJRequest.GetFormString("pay_order_no").ToUpper();
            decimal order_amount = QJRequest.GetFormDecimal("pay_order_amount", 0);
            string user_name = QJRequest.GetFormString("pay_user_name");
            string subject = QJRequest.GetFormString("pay_subject");
            //以下收货人信息
            ...
            sParaTemp.Add("exter_invoke_ip", QJRequest.GetIP()); ////获取客户端的IP地址
