...
namespace QJcms.Web.api.payment.tenpay
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //=============================获得订单信息================================
            string order_no = QJRequest.GetFormString("pay_order_no").ToUpper(); //订单号
            decimal order_amount = QJRequest.GetFormDecimal("pay_order_amount", 0); //订单金额
            string user_name = QJRequest.GetFormString("pay_user_name"); //支付用户名
            string subject = QJRequest.GetFormString("pay_subject"); //备注说明
