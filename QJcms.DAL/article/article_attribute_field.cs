...
namespace QJcms.DAL
{
    ...
    public partial class article_attribute_field
    {
        ...
        public bool Exists(string column_name)
        {
            ...
            if (DbHelperSQL.Exists(strSql.ToString(), parameters) || DbHelperSQL.ExitColumnName(databaseprefix + "article", column_name))
            {
                return true;
            }
            return false;
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        SqlParameter[] parameters = {
					        ...
					        new SqlParameter("@data_place", SqlDbType.Int,4),
					        new SqlParameter("@item_option", SqlDbType.NVarChar),
					        new SqlParameter("@default_value", SqlDbType.NVarChar),
					        new SqlParameter("@is_required", SqlDbType.Int,4),
					        new SqlParameter("@is_password", SqlDbType.Int,4),
					        new SqlParameter("@is_html", SqlDbType.Int,4),
					        new SqlParameter("@editor_type", SqlDbType.Int,4),
