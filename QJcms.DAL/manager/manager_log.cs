...
namespace QJcms.DAL
{
    ...
    public partial class manager_log
    {
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("role_type,user_id,user_name,action_type,remark,user_ip)");
                        ...
                        parameters[0].Value = model.role_type;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,role_type,user_id,user_name,action_type,remark,user_ip,add_time from " + databaseprefix + "manager_log ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        ///// 删除7天前的日志数据
        ///// </summary>
        public int Delete(int dayCount, int user_id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from " + databaseprefix + "manager_log "); 
            if (dayCount > 0)
            ...
            else { strSql.Append(" where user_id=" + user_id); }
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,role_type,user_id,user_name,action_type,remark,user_ip,add_time ");
