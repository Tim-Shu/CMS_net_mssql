...
namespace QJcms.BLL
{
	...
	public partial class navigation
	{
		...
		public navigation()
		{
            dal = new DAL.navigation(QJKey.DatabasePrefix);
        }
        ...
        /// <param name="islock">显示/隐藏</param>
        /// <returns></returns>
        public bool Update(string old_name, string new_name, string title, int islock)
        {
            return dal.Update(old_name, new_name, title, islock);
        }
        ...
        /// <summary>
        /// 取得所有可显示类别列表(没有排序好，只有数据)
        /// </summary>
        /// <param name="parent_id">父ID，0为所有类别</param>
        /// <param name="nav_type">导航类别</param>
        /// <returns>DataTable</returns>
        public DataTable GeShowList(int parent_id, string nav_type)
        {
            return dal.GeShowList(parent_id, nav_type);
        }
        #endregion
    }
}
