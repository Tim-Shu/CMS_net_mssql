...
namespace QJcms.BLL
{
    ...
    public partial class users
    {
        ...
        public users()
        {
            dal = new DAL.users(QJKey.DatabasePrefix);
        }
        ...
        public bool Upgrade(int id)
        {
            ...
            if (result > 0)
            {
                ...
                {
                    new BLL.user_amount_log().Add(model.id, model.user_name, QJEnums.AmountTypeEnum.SysGive.ToString(), groupModel.amount, "升级赠送金额", 1);
                }
            }
            return true;
        }
