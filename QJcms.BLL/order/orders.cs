...
namespace QJcms.BLL
{
    ...
    public partial class orders
    {
        ...
        public orders()
        {
            dal = new DAL.orders(QJKey.DatabasePrefix);
        }
        ...
        {
            dal.UpdateOrderGoodField(id, strValue);
        }
        ...
        public bool Update(Model.orders model)
        {
            ...
            model.order_amount = model.real_amount + model.express_fee + model.payment_fee - ((decimal)(model.point_cost * 0.01));
