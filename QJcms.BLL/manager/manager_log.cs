...
namespace QJcms.BLL
{
    ...
    public partial class manager_log
    {
        ...
        public manager_log()
        {
            dal = new DAL.manager_log(QJKey.DatabasePrefix);
        }
        ...
        /// <param name="备注"></param>
        /// <returns></returns>
        public int Add(int role_type, int user_id, string user_name, string action_type, string remark)
        {
            Model.manager_log manager_log_model = new Model.manager_log();
            manager_log_model.role_type = role_type;
            ...
            manager_log_model.user_ip = QJRequest.GetIP();
        ...
        {
            return dal.Delete(dayCount, user_id);
        }
